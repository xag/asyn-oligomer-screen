...
| 6H6B | cryo-EM | 2 | recombinant 1-121 truncation fibril; paper calls it "cytotoxic" but the cited toxicity is for the truncated *protein* (accelerated aggregation), not these fibrils vs WT | Guerrero-Ferreira et al., eLife 2018 | verified — kept inert per framework rationale (mature fibril = endpoint); see STATUS.md "Anchor anomalies — resolved" |
...
| 6PES | H50Q | 2 | wide polymorph (two protofilaments) | Boyer et al., NSMB 2019 | verified — scores below 6PEO; confirmed as real signal driven by inter-protofilament burial, not an artifact (see STATUS.md) |
